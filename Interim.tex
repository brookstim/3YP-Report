...
\item Keypoint localisation. At the points found from step 1, their location and scale is determined.
...
Whilst these are setbacks, a better basis has been set for the rest of the project. More time will be allocated over Christmas to make up the time that has been lost. From experience and knowledge learnt from Semester 1, a new Gantt Chart has been created in Appendix D to reflect the work already completed, and the updated plan of the work to be completed. 
\newpage
