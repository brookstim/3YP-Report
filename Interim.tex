...
\section{Appendix B}
\subsection{}
\includegraphics[scale=0.45, angle=90]{ganntFIRSTprexmas.png}
\includegraphics[scale=0.5, angle=90]{ganntFIRSTpostxmas.png}
